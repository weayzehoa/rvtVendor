                        ...
                        <div class="row">
                            <div class="col-4 card card-primary card-outline">
                                <div class="card-body">
                                    <div class="text-center mb-2">
                                        <h3>商家主視覺</h3>
                                        <img width="100%" class="new_cover" src="{{ !empty($vendor->new_cover) ? env('AWS_FILE_URL').$vendor->new_cover : '' }}" alt="">
                                    </div>
                            ...
                            <div class="col-4 card card-primary card-outline">
                                <div class="card-body box-profile">
                                    <div class="text-center mb-2">
                                        <h3>LOGO</h3>
                                        <img width="100%" class="new_logo" src="{{ !empty($vendor->new_logo) ? env('AWS_FILE_URL').$vendor->new_logo : '' }}" alt="">
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
