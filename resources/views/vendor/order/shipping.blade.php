                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            @endif
                            <div class="col-12 mb-2">
                                <span class="text-danger text-sm text-bold">注意! 商家出貨單管理，僅供商家出貨參考，實際對帳請依照 iCarry 採購單實際入庫情況對帳。</span>
                            </div>
                ...
                <div class="form-group form-group-sm">
                    <form id="sfmodalForm" action="{{ url('shipping/getSFnumber') }}" method="POST">
                        ...
                        <div>
                            ...
                            <ul>
                                <li><span class="text-danger">只有運送至 iCarry 桃園倉庫的商品</span>才能使用本功能，不適用直寄商品。</li>
